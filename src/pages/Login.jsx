...
const Login = () => {
  ...
  <div className="lg:py-40 py-12">
    <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
      <div className="hidden lg:block lg:w-1/2 bg-cover" style={{backgroundImage: 'url("https://cdn.pixabay.com/photo/2023/05/24/17/49/ai-generated-8015425_1280.jpg")'}}>
      </div>
      <div className="w-full p-8 lg:w-1/2">
        <h2 className="text-2xl font-semibold text-gray-700 text-center">closedAI</h2>
        ...
        <div className="mt-8">
          <button className="bg-gray-900 text-white font-bold py-2 px-4 w-full rounded-lg hover:bg-gray-600">Login</button>
        </div>
        <div className="mt-4 flex items-center justify-between">
          <span className="border-b w-1/5 md:w-1/4" />
          <Link to={"/signup"} href="#" className="text-xs text-blue-500 uppercase">or sign up</Link>
          <span className="border-b w-1/5 md:w-1/4" />
        </div>
      </div>
    </div>
